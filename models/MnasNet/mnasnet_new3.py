...
__all__ = [ 'new3_mnasnet0_5', 'new3_mnasnet0_75', 'new3_mnasnet1_0', 'new3_mnasnet1_3']
...
def new3_mnasnet0_5(pretrained=False, progress=True, **kwargs):
...
def new3_mnasnet0_75(pretrained=False, **kwargs):
...
def new3_mnasnet1_0(pretrained=False, **kwargs):
...
def new3_mnasnet1_3(pretrained=False, **kwargs):
...
def demo():
    net = new3_mnasnet1_0(num_classes=1000)
