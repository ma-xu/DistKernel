...
__all__ = [ 'old_mnasnet0_5', 'old_mnasnet0_75', 'old_mnasnet1_0', 'old_mnasnet1_3']
...
def old_mnasnet0_5(pretrained=False, progress=True, **kwargs):
...
def old_mnasnet0_75(pretrained=False, **kwargs):
...
def old_mnasnet1_0(pretrained=False, **kwargs):
...
def old_mnasnet1_3(pretrained=False, **kwargs):
...
def demo():
    net = old_mnasnet1_0(num_classes=1000)
