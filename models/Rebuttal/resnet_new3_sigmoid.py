...
import math
__all__ = ['new3_sigmoid_resnet18', 'new3_sigmoid_resnet34', 'new3_sigmoid_resnet50', 'new3_sigmoid_resnet101',
           'new3_sigmoid_resnet152']
...
def new3_sigmoid_resnet18(pretrained=False, **kwargs):
...
def new3_sigmoid_resnet34(pretrained=False, **kwargs):
...
def new3_sigmoid_resnet50(pretrained=False, **kwargs):
...
def new3_sigmoid_resnet101(pretrained=False, **kwargs):
...
def new3_sigmoid_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = new3_sigmoid_resnet18(num_classes=1000)
...
def demo2():
    # st = time.perf_counter()
    for i in range(1):
        net = new3_sigmoid_resnet50(num_classes=1000).cuda()
