...
import math
__all__ = ['identica4B_resnet18', 'identica4B_resnet34', 'identica4B_resnet50', 'identica4B_resnet101',
           'identica4B_resnet152']
...
def identica4B_resnet18(pretrained=False, **kwargs):
...
def identica4B_resnet34(pretrained=False, **kwargs):
...
def identica4B_resnet50(pretrained=False, **kwargs):
...
def identica4B_resnet101(pretrained=False, **kwargs):
...
def identica4B_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = identica4B_resnet18(num_classes=1000)
...
def demo2():
    # st = time.perf_counter()
    for i in range(1):
        net = identica4B_resnet50(num_classes=1000).cuda()
