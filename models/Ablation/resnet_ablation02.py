...
# import math
__all__ = ['ablation02_resnet18', 'ablation02_resnet34', 'ablation02_resnet50', 'ablation02_resnet101',
           'ablation02_resnet152']
...
class AssConv(nn.Module):
    ...
    def forward(self, input):
        ...
        weights = self.fc(gap).unsqueeze(dim=-1).unsqueeze(dim=-1)
...
def ablation02_resnet18(pretrained=False, **kwargs):
...
def ablation02_resnet34(pretrained=False, **kwargs):
...
def ablation02_resnet50(pretrained=False, **kwargs):
...
def ablation02_resnet101(pretrained=False, **kwargs):
...
def ablation02_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = ablation02_resnet50(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(100):
        net = ablation02_resnet50(num_classes=1000).cuda()
