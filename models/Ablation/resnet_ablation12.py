...
import math
__all__ = ['ablation12_resnet18', 'ablation12_resnet34', 'ablation12_resnet50', 'ablation12_resnet101',
           'ablation12_resnet152']

# PD-B: standard + standard
...
def ablation12_resnet18(pretrained=False, **kwargs):
...
def ablation12_resnet34(pretrained=False, **kwargs):
...
def ablation12_resnet50(pretrained=False, **kwargs):
...
def ablation12_resnet101(pretrained=False, **kwargs):
...
def ablation12_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = ablation12_resnet18(num_classes=1000)
...
def demo2():
    # st = time.perf_counter()
    for i in range(1):
        net = ablation12_resnet50(num_classes=1000).cuda()
