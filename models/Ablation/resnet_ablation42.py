...
import math
__all__ = ['ablation42_resnet18', 'ablation42_resnet34', 'ablation42_resnet50', 'ablation42_resnet101',
           'ablation42_resnet152']

# PD-B: standard + AC + group
...
class AssConv(nn.Module):
    ...
    def forward(self, input):
        ...
        all_out = torch.cat([ori_out,ac_out, group_out], dim=1)
...
def ablation42_resnet18(pretrained=False, **kwargs):
...
def ablation42_resnet34(pretrained=False, **kwargs):
...
def ablation42_resnet50(pretrained=False, **kwargs):
...
def ablation42_resnet101(pretrained=False, **kwargs):
...
def ablation42_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = ablation42_resnet18(num_classes=1000)
...
def demo2():
    # st = time.perf_counter()
    for i in range(1):
        net = ablation42_resnet50(num_classes=1000).cuda()
