...
import math
__all__ = ['ablation32_resnet18', 'ablation32_resnet34', 'ablation32_resnet50', 'ablation32_resnet101',
           'ablation32_resnet152']
...
class AssConv(nn.Module):
    ...
    def forward(self, input):
        ...
        all_out = torch.cat([ori_out, ac_out], dim=1)
...
def ablation32_resnet18(pretrained=False, **kwargs):
...
def ablation32_resnet34(pretrained=False, **kwargs):
...
def ablation32_resnet50(pretrained=False, **kwargs):
...
def ablation32_resnet101(pretrained=False, **kwargs):
...
def ablation32_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = ablation32_resnet18(num_classes=1000)
...
def demo2():
    # st = time.perf_counter()
    for i in range(1):
        net = ablation32_resnet50(num_classes=1000).cuda()
