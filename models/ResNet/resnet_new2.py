...
import math
__all__ = ['new2_resnet18', 'new2_resnet34', 'new2_resnet50', 'new2_resnet101',
           'new2_resnet152']
...
def new2_resnet18(pretrained=False, **kwargs):
...
def new2_resnet34(pretrained=False, **kwargs):
...
def new2_resnet50(pretrained=False, **kwargs):
...
def new2_resnet101(pretrained=False, **kwargs):
...
def new2_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = new2_resnet18(num_classes=1000)
...
def demo2():
    # st = time.perf_counter()
    for i in range(1):
        net = new2_resnet50(num_classes=1000).cuda()
