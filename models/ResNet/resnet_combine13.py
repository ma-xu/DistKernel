...
import math
__all__ = ['combine13_resnet18', 'combine13_resnet34', 'combine13_resnet50', 'combine13_resnet101',
           'combine13_resnet152']
...
class AssConv(nn.Module):
    ...
    def forward(self, input):
        ...
        alpha = all_temp_out.softmax(dim=1).unsqueeze(dim=-1)  # 1*4*C_out*1*1
...
def combine13_resnet18(pretrained=False, **kwargs):
...
def combine13_resnet34(pretrained=False, **kwargs):
...
def combine13_resnet50(pretrained=False, **kwargs):
...
def combine13_resnet101(pretrained=False, **kwargs):
...
def combine13_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = combine13_resnet18(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(1):
        net = combine13_resnet50(num_classes=1000).cuda()
