...
import math
__all__ = ['validate2_resnet18', 'validate2_resnet34', 'validate2_resnet50', 'validate2_resnet101',
           'validate2_resnet152']
...
class AssConv(nn.Module):
    ...
    def forward(self, input):
        ...
        all_out = torch.cat([out_1,out_2],dim=1)
...
def validate2_resnet18(pretrained=False, **kwargs):
...
def validate2_resnet34(pretrained=False, **kwargs):
...
def validate2_resnet50(pretrained=False, **kwargs):
...
def validate2_resnet101(pretrained=False, **kwargs):
...
def validate2_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = validate2_resnet18(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(1):
        net = validate2_resnet50(num_classes=1000).cuda()
