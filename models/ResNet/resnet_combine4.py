...
import math
__all__ = ['combine4_resnet18', 'combine4_resnet34', 'combine4_resnet50', 'combine4_resnet101',
           'combine4_resnet152']
...
def combine4_resnet18(pretrained=False, **kwargs):
...
def combine4_resnet34(pretrained=False, **kwargs):
...
def combine4_resnet50(pretrained=False, **kwargs):
...
def combine4_resnet101(pretrained=False, **kwargs):
...
def combine4_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = combine4_resnet18(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(1):
        net = combine4_resnet50(num_classes=1000).cuda()
