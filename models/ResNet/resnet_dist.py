...
class DPConv(nn.Module):
    def __init__(self, in_planes, out_planes, stride=1):
        ...
        self.distribution = nn.Conv2d(in_planes, out_planes, kernel_size=3, stride=stride,
                     padding=1, bias=False)
        self.perturbation = nn.Conv2d(in_planes, out_planes, kernel_size=3, stride=stride,
                              padding=1, bias=False)
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.dpConv1 = DPConv(inplanes, planes,stride)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        # self.bn2 = nn.BatchNorm2d(planes)
        self.dpConv = DPConv(planes, planes,stride)
