...
import math
__all__ = ['validate4_resnet18', 'validate4_resnet34', 'validate4_resnet50', 'validate4_resnet101',
           'validate4_resnet152']
...
def validate4_resnet18(pretrained=False, **kwargs):
...
def validate4_resnet34(pretrained=False, **kwargs):
...
def validate4_resnet50(pretrained=False, **kwargs):
...
def validate4_resnet101(pretrained=False, **kwargs):
...
def validate4_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = validate4_resnet18(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(1):
        net = validate4_resnet50(num_classes=1000).cuda()
