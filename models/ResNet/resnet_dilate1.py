...
import math
__all__ = ['dilate1_resnet18', 'dilate1_resnet34', 'dilate1_resnet50', 'dilate1_resnet101',
           'dilate1_resnet152']
...
class AssConv(nn.Module):
    ...
    def forward(self, input):
        return self.ori_bn(self.ori_conv(input))+\
               self.sig(self.alpha)*self.dilate_bn(self.dilate_conv(input))
...
def dilate1_resnet18(pretrained=False, **kwargs):
...
def dilate1_resnet34(pretrained=False, **kwargs):
...
def dilate1_resnet50(pretrained=False, **kwargs):
...
def dilate1_resnet101(pretrained=False, **kwargs):
...
def dilate1_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = dilate1_resnet18(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(1):
        net = dilate1_resnet50(num_classes=1000).cuda()
