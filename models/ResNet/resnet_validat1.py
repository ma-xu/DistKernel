...
import math
__all__ = ['validate1_resnet18', 'validate1_resnet34', 'validate1_resnet50', 'validate1_resnet101',
           'validate1_resnet152']
...
def validate1_resnet18(pretrained=False, **kwargs):
...
def validate1_resnet34(pretrained=False, **kwargs):
...
def validate1_resnet50(pretrained=False, **kwargs):
...
def validate1_resnet101(pretrained=False, **kwargs):
...
def validate1_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = validate1_resnet18(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(1):
        net = validate1_resnet50(num_classes=1000).cuda()
