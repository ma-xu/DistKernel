...
import math
__all__ = ['new1_resnet18', 'new1_resnet34', 'new1_resnet50', 'new1_resnet101',
           'new1_resnet152']
...
def new1_resnet18(pretrained=False, **kwargs):
...
def new1_resnet34(pretrained=False, **kwargs):
...
def new1_resnet50(pretrained=False, **kwargs):
...
def new1_resnet101(pretrained=False, **kwargs):
...
def new1_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = new1_resnet18(num_classes=1000)
...
def demo2():
    # st = time.perf_counter()
    for i in range(1):
        net = new1_resnet50(num_classes=1000).cuda()
