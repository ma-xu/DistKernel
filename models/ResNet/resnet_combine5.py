...
import math
__all__ = ['combine5_resnet18', 'combine5_resnet34', 'combine5_resnet50', 'combine5_resnet101',
           'combine5_resnet152']
...
def combine5_resnet18(pretrained=False, **kwargs):
...
def combine5_resnet34(pretrained=False, **kwargs):
...
def combine5_resnet50(pretrained=False, **kwargs):
...
def combine5_resnet101(pretrained=False, **kwargs):
...
def combine5_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = combine5_resnet18(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(1):
        net = combine5_resnet50(num_classes=1000).cuda()
