...
import math
__all__ = ['combine19_resnet18', 'combine19_resnet34', 'combine19_resnet50', 'combine19_resnet101',
           'combine19_resnet152']
...
def combine19_resnet18(pretrained=False, **kwargs):
...
def combine19_resnet34(pretrained=False, **kwargs):
...
def combine19_resnet50(pretrained=False, **kwargs):
...
def combine19_resnet101(pretrained=False, **kwargs):
...
def combine19_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = combine19_resnet18(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(1):
        net = combine19_resnet50(num_classes=1000).cuda()
