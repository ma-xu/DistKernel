...
import math
__all__ = ['combine1_resnet18', 'combine1_resnet34', 'combine1_resnet50', 'combine1_resnet101',
           'combine1_resnet152']
...
def combine1_resnet18(pretrained=False, **kwargs):
...
def combine1_resnet34(pretrained=False, **kwargs):
...
def combine1_resnet50(pretrained=False, **kwargs):
...
def combine1_resnet101(pretrained=False, **kwargs):
...
def combine1_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = combine1_resnet18(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(1):
        net = combine1_resnet50(num_classes=1000).cuda()
