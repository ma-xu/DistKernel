...
import math
__all__ = ['combine20_resnet18', 'combine20_resnet34', 'combine20_resnet50', 'combine20_resnet101',
           'combine20_resnet152']
...
def combine20_resnet18(pretrained=False, **kwargs):
...
def combine20_resnet34(pretrained=False, **kwargs):
...
def combine20_resnet50(pretrained=False, **kwargs):
...
def combine20_resnet101(pretrained=False, **kwargs):
...
def combine20_resnet152(pretrained=False, **kwargs):
...
def demo2():
    st = time.perf_counter()
    for i in range(1):
        net = combine20_resnet50(num_classes=1000).cuda()
