...
import math
__all__ = ['dist5_resnet18', 'dist5_resnet34', 'dist5_resnet50', 'dist5_resnet101',
           'dist5_resnet152']
...
def dist5_resnet18(pretrained=False, **kwargs):
...
def dist5_resnet34(pretrained=False, **kwargs):
...
def dist5_resnet50(pretrained=False, **kwargs):
...
def dist5_resnet101(pretrained=False, **kwargs):
...
def dist5_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = dist5_resnet50(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(50):
        net = dist5_resnet50(num_classes=1000).cuda()
