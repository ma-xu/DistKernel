...
# import math
__all__ = ['group3_resnet18', 'group3_resnet34', 'group3_resnet50', 'group3_resnet101',
           'group3_resnet152']
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.conv1 = AssConv(inplanes, planes, kernel_size=3, stride=stride, padding=1, bias=False,groups=[1,8,64])
...
def group3_resnet18(pretrained=False, **kwargs):
...
def group3_resnet34(pretrained=False, **kwargs):
...
def group3_resnet50(pretrained=False, **kwargs):
...
def group3_resnet101(pretrained=False, **kwargs):
...
def group3_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = group3_resnet18(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(1):
        net = group3_resnet50(num_classes=1000).cuda()
