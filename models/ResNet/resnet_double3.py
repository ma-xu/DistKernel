...
import math
__all__ = ['double3_resnet18', 'double3_resnet34', 'double3_resnet50', 'double3_resnet101',
           'double3_resnet152']
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.conv1 = AssConv(inplanes, planes, kernel_size=1, stride=1, padding=0, bias=False)
        # self.conv1 = conv1x1(inplanes, planes)
        # self.bn1 = nn.BatchNorm2d(planes)
        self.conv2 = AssConv(planes, planes, kernel_size=3, stride=stride, padding=1, bias=False)
        # self.bn2 = nn.BatchNorm2d(planes)
        self.conv3 = AssConv(planes, planes * self.expansion, kernel_size=1, stride=1, padding=0, bias=False)
...
def double3_resnet18(pretrained=False, **kwargs):
...
def double3_resnet34(pretrained=False, **kwargs):
...
def double3_resnet50(pretrained=False, **kwargs):
...
def double3_resnet101(pretrained=False, **kwargs):
...
def double3_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = double3_resnet50(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(1):
        net = double3_resnet50(num_classes=1000).cuda()
