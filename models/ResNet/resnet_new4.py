...
import math
__all__ = ['new4_resnet18', 'new4_resnet34', 'new4_resnet50', 'new4_resnet101',
           'new4_resnet152']
...
def new4_resnet18(pretrained=False, **kwargs):
...
def new4_resnet34(pretrained=False, **kwargs):
...
def new4_resnet50(pretrained=False, **kwargs):
...
def new4_resnet101(pretrained=False, **kwargs):
...
def new4_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = new4_resnet18(num_classes=1000)
...
def demo2():
    # st = time.perf_counter()
    for i in range(1):
        net = new4_resnet50(num_classes=1000).cuda()
