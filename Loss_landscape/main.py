"""
nohup python main.py -a old_resnet18 --evaluate --resume old_resnet18_model_best.pth.tar > loss_old_resnet18_new.log &
nohup python main.py -a new1_resnet18 --evaluate --resume new1_resnet18_model_best.pth.tar > loss_new1_resnet18_new.log &
nohup python main.py -a new3_resnet18 --evaluate --resume new3_resnet18_model_best.pth.tar > loss_new3_resnet18_new.log &
"""
import argparse
import os
import random
