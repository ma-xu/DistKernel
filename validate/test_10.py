...
def demo():
    ...
    for  m in net.modules():
        if isinstance(m, BasicBlock):
            c_out,c_in,k1,k2 = m.conv1.weight.shape
            print("Suppose var = {}".format(2 / (c_out * k1 * k2)))
            print("Real    var = {}".format(m.conv1.weight.var()))
            print("Real   mean = {}".format(m.conv1.weight.mean()))
